...
export default function IndigeneForm() {
    ...
    return (
        <>
            <h2 className="font-semibold md:text-lg text-zinc-600 mb-1">Indigene Application Form</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="relative w-full bg-white rounded-lg p-8 mb-4">
                ...
                <div className="font-semibold rounded-md border bg-white text-primary py-2 px-4 mb-8">
                    {"John Doe"}
                </div>
