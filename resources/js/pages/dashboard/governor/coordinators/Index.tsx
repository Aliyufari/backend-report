...
import DeleteCoordinatorModal from "./DeleteCoordinatorModal";
import DataTable from "@/components/ui/DataTable";
import coordinators from "@/routes/governor/users";
...
export default function CoordinatorsIndex() {
    ...
    const columns: Column<User>[] = [
        { key: "name", label: "Coordinator", type: "slot" },
        {
            key: "email",
            label: "Email",
            accessor: (row) => (
    ...
    return (
        <>
            ...
            <AppLayout
                ...
                title="Coordinators"
                sub="Create and manage coordinators in your state"
                live={false}
                actions={
                    <button
                        onClick={openCreate}
            ...
            >
                <DataTable
                    data={usersData}
                    columns={columns}
                    indexUrl={coordinators.index().url}
