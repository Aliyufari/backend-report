...
import AdminSideNavLinks from "../admin/AdminSideNavLinks";
import ApplicantSideNavLinks from "../applicant/ApplicantSideNavLinks";
...
export default function MobileNavigation({ showMobile, onClose }: MobileProps) {
    ...
    const navLinks: Record<Roles, JSX.Element> = {
        super_admin: <AdminSideNavLinks />,
        admin: <AdminSideNavLinks />,
        governor: <AdminSideNavLinks />,
