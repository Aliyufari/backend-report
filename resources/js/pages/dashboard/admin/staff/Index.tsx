...
export default function StaffIndex() {
    ...
    const { staff: staffData, states, departments, statuses, filters, flash, statistics, permissions } = props;
    ...
    return (
        <>
            ...
            <AppLayout
                ...
                title="Staffing"
                sub="Manage INEC department staff records"
                live
                actions={
                ...
                <DataTable
                    ...
                    columns={[
                        ...
                        },
                        {
                            ...
                            accessor: (row: StaffMember) => <span className="text-xs text-muted-foreground">{row.state?.name ?? "HQ"}</span>,
                        },
                        {
