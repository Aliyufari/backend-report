...
// Defines, per starting scope, which dropdowns render and which
// nested key holds the next level's children.
...
export default function CvrModal({ open, onClose, locations, locationScope, types, statuses, cvr }: Props) {
    const isEdit = !!cvr;
    ...
    useEffect(() => {
        ...
        // Scoped roles (zone/lga/ward) usually have a single root option — preselect it
        // so the user isn't stuck picking from a one-item dropdown.
