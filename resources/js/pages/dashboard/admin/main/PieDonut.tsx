...
// Month Target by Senatorial Zone — matches reference image
const COLORS = {
    leboku:    "#22c55e",
    ikot_ansa: "#3b82f6",
    ikot_ekpo: "#f59e0b",
    ...
    return (
        <Card data-chart={id} className="flex flex-col">
            ...
            <CardContent className="flex flex-col items-center pt-0 pb-4">
                <ChartContainer id={id} config={chartConfig} className="w-full h-[220px]">
                    <PieChart>
                        <ChartTooltip
                            cursor={false}
                                        ...
                                        return (
                                            <text x={viewBox.cx} y={viewBox.cy} textAnchor="middle" dominantBaseline="middle">
                                                <tspan
                                                    x={viewBox.cx}
                                                    y={(viewBox.cy ?? 0) - 8}
                                                    style={{ fontFamily: "'Syne', sans-serif", fontSize: 24, fontWeight: 800, fill: "var(--foreground)" }}
                                                >
                                                ...
                                                <tspan
                                                    x={viewBox.cx}
                                                    y={(viewBox.cy ?? 0) + 16}
                                                    style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, fill: "var(--muted-foreground)" }}
                                                >
